...
- [ ] Docker Foundations (Is the Docker engine active locally? Do I remember `docker ps`?)
- [ ] AWS CLI Local Configurations (Is the CLI installed and ready to accept custom endpoints?)
